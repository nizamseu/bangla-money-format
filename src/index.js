...
const englishEquivalents = {
  "একশত কোটি": "এক বিলিয়ন", // 10^9 - অর্বুদ
  "এক হাজার কোটি": "দশ বিলিয়ন", // 10^10 - খর্ব
  "দশ হাজার কোটি": "একশ বিলিয়ন", // 10^11 - নিল
  "এক লক্ষ কোটি": "এক ট্রিলিয়ন", // 10^12 - পদ্ম
  "দশ লক্ষ কোটি": "দশ ট্রিলিয়ন", // 10^13 - শঙ্খ
  "এক কোটি কোটি": "একশ ট্রিলিয়ন", // 10^14 - মহাশঙ্খ
  "দশ কোটি কোটি": "এক কোয়াড্রিলিয়ন", // 10^15 - অন্ত্য
  "একশত কোটি কোটি": "দশ কোয়াড্রিলিয়ন", // 10^16 - মধ্য
  "এক হাজার কোটি কোটি": "একশ কোয়াড্রিলিয়ন", // 10^17 - পরার্ধ
  "দশ হাজার কোটি কোটি": "এক কুইন্টিলিয়ন", // 10^18 - অপরার্ধ
  "এক লক্ষ কোটি কোটি": "দশ কুইন্টিলিয়ন", // 10^19 - উৎপল
  "দশ লক্ষ কোটি কোটি": "একশ কুইন্টিলিয়ন", // 10^20 - নিকুমুদ
};
...
function numberToBanglaTraditional(num) {
  ...
  const traditionalUnits = [
    [BigInt("100000000000000000000"), "দশ লক্ষ কোটি কোটি"], // 10^20 - নিকুমুদ
    [BigInt("10000000000000000000"), "এক লক্ষ কোটি কোটি"], // 10^19 - উৎপল
    [BigInt("1000000000000000000"), "দশ হাজার কোটি কোটি"], // 10^18 - অপরার্ধ
    [BigInt("100000000000000000"), "এক হাজার কোটি কোটি"], // 10^17 - পরার্ধ
    [BigInt("10000000000000000"), "একশত কোটি কোটি"], // 10^16 - মধ্য
    [BigInt("1000000000000000"), "দশ কোটি কোটি"], // 10^15 - অন্ত্য
    [BigInt("100000000000000"), "এক কোটি কোটি"], // 10^14 - মহাশঙ্খ
    [BigInt("10000000000000"), "দশ লক্ষ কোটি"], // 10^13 - শঙ্খ
    [BigInt("1000000000000"), "এক লক্ষ কোটি"], // 10^12 - পদ্ম
    [BigInt("100000000000"), "দশ হাজার কোটি"], // 10^11 - নিল
    [BigInt("10000000000"), "এক হাজার কোটি"], // 10^10 - খর্ব
    [BigInt("1000000000"), "একশত কোটি"], // 10^9 - অর্বুদ
    [BigInt("10000000"), "কোটি"], // 10^7
    [BigInt("100000"), "লাখ"], // 10^5
    [BigInt("1000"), "হাজার"], // 10^3
  ];
  ...
  for (const [divisor, unit] of traditionalUnits) {
    if (remainingNum >= divisor) {
      ...
      const convertedVal = convertBelowThousand(val);
      if (convertedVal) {
        // For traditional scales, if the value is 1, just use the unit name
        if (val === 1) {
          parts.push(unit);
        } else {
          parts.push(convertedVal + " " + unit);
...
function addEnglishEquivalent(text) {
  let result = text;
  const scales = [
    ["দশ লক্ষ কোটি কোটি", englishEquivalents["দশ লক্ষ কোটি কোটি"]],
    ["এক লক্ষ কোটি কোটি", englishEquivalents["এক লক্ষ কোটি কোটি"]],
    ["দশ হাজার কোটি কোটি", englishEquivalents["দশ হাজার কোটি কোটি"]],
    ["এক হাজার কোটি কোটি", englishEquivalents["এক হাজার কোটি কোটি"]],
    ["একশত কোটি কোটি", englishEquivalents["একশত কোটি কোটি"]],
    ["দশ কোটি কোটি", englishEquivalents["দশ কোটি কোটি"]],
    ["এক কোটি কোটি", englishEquivalents["এক কোটি কোটি"]],
    ["দশ লক্ষ কোটি", englishEquivalents["দশ লক্ষ কোটি"]],
    ["এক লক্ষ কোটি", englishEquivalents["এক লক্ষ কোটি"]],
    ["দশ হাজার কোটি", englishEquivalents["দশ হাজার কোটি"]],
    ["এক হাজার কোটি", englishEquivalents["এক হাজার কোটি"]],
    ["একশত কোটি", englishEquivalents["একশত কোটি"]],
  ];
